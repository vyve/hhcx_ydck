...
public final class VLViewfinderView extends View {
	...
	public VLViewfinderView(Context context, int w, int h) {
		super(context);
		this.w = w;
		this.h = h;
		paint = new Paint();
	...
	public VLViewfinderView(Context context, int w, int h, boolean boo) {
		super(context);
		this.w = w;
		this.h = h;
		this.boo = boo;
	...
	public void onDraw(Canvas canvas) {
		...
		if (width > height && !boo) {
			...
			paintLine.setAntiAlias(true);
			int num =(b-t)/6;
			canvas.drawLine(l, t, l + num, t, paintLine);
			canvas.drawLine(l, t, l, t + num, paintLine);
			canvas.drawLine(r, t, r - num, t, paintLine);
			canvas.drawLine(r, t, r, t + num, paintLine);
			canvas.drawLine(l, b, l + num, b, paintLine);
			canvas.drawLine(l, b, l, b - num, paintLine);
			canvas.drawLine(r, b, r - num, b, paintLine);
		...
		mText = "行驶证";
	     ...
	     mTextPaint.setTextSize(height/18);  
