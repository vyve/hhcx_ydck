...
/**
	 ...
	 * @param textSize3
	 */
	public void setTextSize(int textSize1,int textSize2,int textSize3) {
		wv_option1.setTextSize(textSize1);
		wv_option2.setTextSize(textSize2);
		wv_option3.setTextSize(textSize3);
	}
	/**
