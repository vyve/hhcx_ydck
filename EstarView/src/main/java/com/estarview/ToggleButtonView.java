...
public class ToggleButtonView extends View{
	...
	private ToggleButtonView(Context context) {
		super(context);
	}
	...
	public void setup(AttributeSet attrs) {
		...
		offBorderColor = typedArray.getColor(R.styleable.ToggleButtonView_offBorderColor, offBorderColor);
		onColor = typedArray.getColor(R.styleable.ToggleButtonView_onColor, onColor);
		spotColor = typedArray.getColor(R.styleable.ToggleButtonView_spotColor, spotColor);
		offColor = typedArray.getColor(R.styleable.ToggleButtonView_offColor, offColor);
		borderWidth = typedArray.getDimensionPixelSize(R.styleable.ToggleButtonView_borderWidth, borderWidth);
		defaultAnimate = typedArray.getBoolean(R.styleable.ToggleButtonView_animate, defaultAnimate);
		isDefaultOn = typedArray.getBoolean(R.styleable.ToggleButtonView_isDefaultOn, isDefaultOn);
		typedArray.recycle();
